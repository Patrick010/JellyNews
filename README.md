...
For defaults, see `Jellyfin.Plugin.JellyNews/Templates/`
...
Some of these may not interest that average user (if anyone), but I figured I would have any element in the JellyNews.db be available for use! <br>
